...
public class HealthServiceAddDoctorTest extends BaseSeleniumTest{
    ...
    public void HealthServiceTest() throws IOException {
        ...
        specId.sendKeys("4");
        addDoctor2.click();
        String actualString = driver.findElement(By.xpath("//tbody")).getText();
        String expectedString = "Alicja Kaczyńska";
